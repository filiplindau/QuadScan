...
class Ui_QuadFileDialog(object):
    def setupUi(self, QuadFileDialog):
        ...
        self.dir_listwidget = QtGui.QListWidget(self.splitter)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.dir_listwidget.sizePolicy().hasHeightForWidth())
        self.dir_listwidget.setSizePolicy(sizePolicy)
        self.dir_listwidget.setObjectName(_fromUtf8("dir_listwidget"))
