...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.k1_slider, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.k4_max_spinbox, 9, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.screen_max_spinbox, 10, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.k4_slider, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.k1_max_spinbox, 6, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.k3_max_spinbox, 8, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.k3_min_spinbox, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.k4_min_spinbox, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.k3_slider, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.k2_min_spinbox, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.k2_max_spinbox, 7, 3, 1, 1)
        self.screen_min_spinbox = QtWidgets.QDoubleSpinBox(Dialog)
        self.screen_min_spinbox.setObjectName("screen_min_spinbox")
        self.gridLayout.addWidget(self.screen_min_spinbox, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.k2_slider, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.screen_slider, 10, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.k4_spinbox, 9, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.screen_spinbox, 10, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.k2_spinbox, 7, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.k3_spinbox, 8, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.k1_spinbox, 6, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.k1_min_spinbox, 6, 1, 1, 1)
        ...
        self.sigma_label = QtWidgets.QLabel(Dialog)
        self.sigma_label.setObjectName("sigma_label")
        self.gridLayout.addWidget(self.sigma_label, 12, 4, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_12.setText(_translate("Dialog", "sigma"))
        self.sigma_label.setText(_translate("Dialog", "-.--"))
